...
insert into producto (id, nombre, precio, descripcion,descuento,color,categoria_id,categoria) values (NEXTVAL('hibernate_sequence'),'champoo',10,'champoo para calvos',0,'rojo',1,2);
insert into producto (id, nombre, precio, descripcion,descuento,color,categoria_id,categoria) values (NEXTVAL('hibernate_sequence'),'gomina',10,'gomina para no calvos',0,'verde',2,2);
